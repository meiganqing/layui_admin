...
layui.use(["jquery"], function() {
    ...
    //	900010: "90000"
    //})
    //权限配置start//type:1访问 2添加/编辑 3删除 4导出 5审核
    //		end_key:存进去的key值
...
layui.use(["layer"], function() {
    ...
    //		if(!limitConfig("wwbhLimt", 3, "删除")) {
    //			return false
    //		}
    //
    //	})
    //	$(".userLimit-btn-edit").click(function() {
    //		if(!limitConfig("wwbhLimt", 2, "编辑")) {
    //			return false
    //		}
    //
    //	})
    //	$(".userLimit-btn-export").click(function() {
    //		if(!limitConfig("wwbhLimt", 4, "导出")) {
    //			return false
    //		}
    //
    //	})
